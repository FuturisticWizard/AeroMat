...
export const Tabs = ({
  ...
  return (
    <>
      <div
        className={cn(
          "flex flex-row flex-wrap items-center justify-start relative overflow-visible sm:overflow-visible no-visible-scrollbar max-w-full w-full min-h-24 lsm:min-h-none ",
          containerClassName,
        )}
      >

...
const CardFlip = ({ icon='/placeholders/64x64.svg', imageBack='/images/lpec-dom1.jpg', imageFront='/images/lpec-dom2.jpg', title='title', description='description' , color = 'purple' , classname='' }) => {
      ...
      <div className="flip-card rounded-md" onClick={handleFlip}> 
        ...
        >
              ...
              {/* Card Content */}
                <div className='p-11'>
                  <div className={`w-full flex items-center justify-center `}>
                    <div className={`rounded-full px-4 py-4  group-hover:bg-white bg-${color} `}>
                  ...
                  <div className="w-full flex flex-col items-center justify-center ">
                    ...
                    <h3 className="text-2xl lg:text-xl font-semibold pt-4 pb-2 w-full text-center" style={{
                  ...
                  <div className="w-full flex flex-col items-center justify-start text-center ">
                    <p className="lg:text-lg text-[#6B6B6B] group-hover:text-white leading-normal px-4 py-4" style={{
                        transform: 'translate3d(0, 0, 0)', // Force GPU rendering
                        backfaceVisibility: 'hidden',     // Prevent rendering artifacts
                        WebkitFontSmoothing: 'antialiased', // Improve font clarity
                        MozOsxFontSmoothing: 'grayscale', // Optimize font rendering in Firefox
                    ...
                    <Button size='lg'  className={`py-6 px-2  bg-${color} shadow-inner `} style={{
                        transform: 'translate3d(0, 0, 0)', // Force GPU rendering
                        backfaceVisibility: 'hidden',     // Prevent rendering artifacts
                        WebkitFontSmoothing: 'antialiased', // Improve font clarity
                        MozOsxFontSmoothing: 'grayscale', // Optimize font rendering in Firefox
                ...
                <div className="absolute inset-0 h-full bg-gradient-to-tr from-transparent via-black/40 to-black/80 rounded-md " />
                 ...
                 <div className=' flex w-full h-full justify-center items-center  text-white/70 z-10'> 
                    <div className={`absolute inset-0 h-full  hidden md:group-hover:block md:group-hover:opacity-75 z-10`} style={{ backgroundColor: `#${color}`}}/>
              ...
              <div className="absolute inset-0 h-full rounded-md opacity-90 "  style={{ backgroundColor: `#${color}`}} />
                ...
                <div id="flip" className='absolute left-1/2 top-1/2 transform -translate-x-1/2 -translate-y-1/2  text-white/70 group-hover:z-40 '> 

  ...
  return (
    <div className='max-w-6xl mx-auto justify-center items-center px-8 lsm:px-0 py-8 md:py-16'>
      ...
      <div className='flex flex-row order-2 sm:order-1 z-30 pb-4 lsm:pb-8 gap-4'>
        ...
        Murale AeroMat to nie tylko dzieła sztuki, ale także elementy, które ożywiają przestrzeń publiczną i tworzą unikalny charakter miasta. Każdy mural jest opisany i zlokalizowany, dzięki czemu możesz łatwo odnaleźć je podczas spaceru po mieście.
        </p>
      </div>
      <MapComponent />

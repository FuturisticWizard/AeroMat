...
/**
 * Inline SVG social icons — replaces @fortawesome bundle (~40 KiB critical path
 * shipped for just 3 icons). Each icon here is ~200 B inline.
 * Paths from Simple Icons (CC0), simplified.
 */

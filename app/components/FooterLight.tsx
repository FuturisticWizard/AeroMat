...
// Alternative footer with black → light gray gradient.
// Use by importing instead of Footer: `import Footer from "./components/FooterLight";`
const FooterLight = () => {
  return (
    <footer className="bg-gradient-to-b from-black to-gray-200 pt-24 md:pt-48 pb-12 px-4">
      <div className="container mx-auto">
        ...
        <div className=" mt-8 pt-8 text-center text-neutral-700">

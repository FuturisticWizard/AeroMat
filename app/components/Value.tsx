    ...
    <div className='relative  h-screen justify-center text-center'>
        ...
        <div className='relative  grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 mx-auto justify-center items-center'>
        {
          items.map((item, index) => (
            <div key={index} className={`relative h-[444px] w-[222px] flex flex-col justify-center items-center text-white`}>
              <div className={`flex flex-col w-[222px] h-[222px] justify-center items-center bg-[${item.color}]`}>
                {item.number && (

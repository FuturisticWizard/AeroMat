...
const items = [
  {
    ...
    icon: <Image src='/icons/VectorClients.png' sizes="100vw" width="48" height="0"  style={{  height: 'auto' }}  alt="smile" /> 
    // width={64} height={64} 
  },
  {
    number: '10+',
    ...
    <div className='2xl:py-36 overflow-hidden '>
      ...
      <div className='flex items-center bg-[#F5F7FA] w-full  '>
          ...
          <div className=' items-center px-6 sm:px-10 py-2 '>
              <h2 className='text-[#4D4D4D] font-semibold xl:text-3xl xxs:py-2 sm:py-0 '>Pomagamy lokalnym biznesom <br/>
                  <span className='text-[#4CAF4F] font-semibold xl:text-3xl '>wyróżnić się i przyciągnąć klienta</span>
              </h2>
              <p className='text-sm xl:text-base text-[#18191F] '>Dotarliśmy tutaj dzięki naszej ciężkiej pracy i poświęceniu</p>
          </div>
          <div className='grid grid-cols-1 md:grid-cols-2 gap-2 xl:gap-4  items-center justify-center xxs:py-2 sm:py-6  px-6 sm:px-10  md:mx-auto'>
          {
              items.map((item, index) => (
                  ...
                  <div className='flex flex-row gap-2 items-center ' >
                      ...
                      <h3 className='text-base lg:text-xl font-bold text-[#18191F]'>{item.number}</h3>
                      <h3 className='lg:text-base text-[#18191F] text-nowrap'>{item.title}</h3>

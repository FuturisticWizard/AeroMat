...
const PoiMarkers = (props: { pois: Poi[] }) => {
    ...
    const [infoWindowPosition, setInfoWindowPosition] = useState<google.maps.LatLng | null>(null); // Position of the InfoWindow
...
const GoogleMap = () => {
  return (
    ...
    >
      ...
      <div className="w-full h-[400px] sm:h-[500px] lg:h-[800px]"> {/* Responsive height */}
        <Map
          defaultZoom={11}
